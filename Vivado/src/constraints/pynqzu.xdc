...
set_property PACKAGE_PIN AC2 [get_ports {clk_sel[0]}]; # LA19_N
set_property IOSTANDARD LVCMOS12 [get_ports {clk_sel[0]}]

set_property PACKAGE_PIN AB2 [get_ports {clk_sel[1]}]; # LA19_P
...
set_property PACKAGE_PIN T6 [get_ports {gpio_tri_o[4]}]; # LA13_N All cameras: FSIN (for synchronization)
set_property PACKAGE_PIN R6 [get_ports {gpio_tri_o[5]}]; # LA13_P Reserved
...
set_property PACKAGE_PIN AE2 [get_ports {mipi_phy_if_2_data_p[3]}]; # LA21_P
set_property PACKAGE_PIN AF2 [get_ports {mipi_phy_if_2_data_n[3]}]; # LA21_N

...
set_property PACKAGE_PIN AG10 [get_ports {clk_sel[0]}]; # LA19_N
set_property IOSTANDARD LVCMOS12 [get_ports {clk_sel[0]}]

set_property PACKAGE_PIN AF10 [get_ports {clk_sel[1]}]; # LA19_P
...
set_property PACKAGE_PIN AK15 [get_ports {gpio_tri_o[4]}]; # LA13_N All cameras: FSIN (for synchronization)
set_property PACKAGE_PIN AJ15 [get_ports {gpio_tri_o[5]}]; # LA13_P Reserved
...
set_property PACKAGE_PIN AC17 [get_ports {mipi_phy_if_0_data_p[2]}]; # LA06_P
set_property PACKAGE_PIN AC18 [get_ports {mipi_phy_if_0_data_n[2]}]; # LA06_N
set_property PACKAGE_PIN AG16 [get_ports {mipi_phy_if_0_data_p[3]}]; # LA10_P
set_property PACKAGE_PIN AH16 [get_ports {mipi_phy_if_0_data_n[3]}]; # LA10_N

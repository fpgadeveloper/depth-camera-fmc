...
set_property PACKAGE_PIN K13 [get_ports {clk_sel[0]}]; # LA19_N
set_property IOSTANDARD LVCMOS12 [get_ports {clk_sel[0]}]

set_property PACKAGE_PIN L13 [get_ports {clk_sel[1]}]; # LA19_P
...
set_property PACKAGE_PIN AC8 [get_ports {gpio_tri_o[4]}]; # LA13_N All cameras: FSIN (for synchronization)
set_property PACKAGE_PIN AB8 [get_ports {gpio_tri_o[5]}]; # LA13_P Reserved
...
set_property PACKAGE_PIN W7 [get_ports {mipi_phy_if_1_data_p[2]}]; # LA12_P
set_property PACKAGE_PIN W6 [get_ports {mipi_phy_if_1_data_n[2]}]; # LA12_N
...
set_property PACKAGE_PIN N13 [get_ports {mipi_phy_if_2_data_p[2]}]; # LA20_P
set_property PACKAGE_PIN M13 [get_ports {mipi_phy_if_2_data_n[2]}]; # LA20_N
set_property PACKAGE_PIN P12 [get_ports {mipi_phy_if_2_data_p[3]}]; # LA21_P
set_property PACKAGE_PIN N12 [get_ports {mipi_phy_if_2_data_n[3]}]; # LA21_N
